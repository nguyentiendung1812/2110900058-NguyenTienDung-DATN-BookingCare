...
class BookingModal extends Component {
  ...
  handleConfirmBooking = async () => {
    ...
    if (!this.state.patientName || !this.state.phoneNumber || !this.state.email || !this.state.address) {
      // Hiển thị thông báo lỗi khi có trường không được nhập
      // Bạn có thể sử dụng toast.error() hoặc một cách thức khác để hiển thị thông báo lỗi
              ...
              <div className="row">
                <div className="col-6 form-group">
                  ...
                  {!this.state.patientName && (
                    <span className="error-message">Vui lòng nhập tên bệnh nhân!</span>
                  )}
                </div>
                <div className="col-6 form-group">
                  <label>
                  ...
                  {!this.state.phoneNumber && (
                    <span className="error-message">Vui lòng nhập số điện thoại!</span>
                  )}
                </div>
                <div className="col-6 form-group">
                  <label>
