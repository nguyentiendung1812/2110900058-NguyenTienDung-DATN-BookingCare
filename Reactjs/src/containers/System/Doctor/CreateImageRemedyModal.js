      ...
      >
        ...
        <ModalBody>
          <div className="row">
                              ...
                              <div className="col-12 form-group">
                                <div className="row align-item-center text-center">
                                    ...
                                    <div className="col-auto">
                                        <select className="form-control" onChange={(event)=>this.handleOnchangeUnitDrug(event,drug.id)} value={drug.unit}>
                                    ...
                                    <div className="col-5"> <input onChange={(event)=>this.handleOnchangeDescriptionUsageDrug(event,drug.id)} type="text" value={drug.desciption} className="form-control" placeholder="Enter desription" /></div>
                                    <div className="col-1 d-flex align-items-center"><i onClick={()=>this.removeDrugFromTheList(drug.id)} className="fas fa-trash pointer text-red"></i></div>
                                </div>
                              </div>
                          );
                        })
            ...
            <div className="col-4">
                    <div className="row">
                        <div className="col-12">Danh sách thuốc
                          ...
                          <ul className="list-group mt-10" style={{overflowY: "scroll", maxHeight: "400px"}}>
                            {
                              listFilterDrugs.map((drug)=>{
                                return(
                                  <li onClick={()=>this.handlePushDrugToList(drug)} className="list-group-item list-group-item-action d-flex justify-content-between align-items-center pointer"><span>{drug.name}</span> <i className="text-primary fas fa-plus-circle"></i></li>
                                )
                              })
                            }
                          </ul>
